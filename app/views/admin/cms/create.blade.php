			...
			<div class="panel-body">
				{{Form::open(array('route' => 'cms.store','role'=>'form','files'=> true , 'method' => 'post'))}}
				    <div class="form-group">
                        ...
                        {{Form::select('contenttype' , $contenttype ,'' , ['class' => 'form-control' , 'id' => 'content-page' , 'data-target' => route('cms.ajax.contentvalue')])}}
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea placeholder="Content" name="textcontent" class="form-control"></textarea>
					</div>
