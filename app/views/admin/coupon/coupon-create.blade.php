				...
				<div class="row mt">
                  <div class="col-md-12">
                      ...
                      <div class="form-panel">
                      	...
                      	<hr>
                      	{{Form::open(['class' => 'form-horizontal style-form' ,'method' => 'post', 'route' => 'cpanel.coupon.create'])}}
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  {{Form::select('type',['absolute' => 'Absolute', 'percent' => 'Percentage'],'Absolute', ['class' => 'form-control'])}}
                              </div>
                         </div>
                         <div class="form-group">
